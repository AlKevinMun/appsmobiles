...
public class ItunesFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        itunesViewModel.respuestaMutableLiveData.observe(getViewLifecycleOwner(), new Observer<Itunes.Respuesta>() {
            ...
            public void onChanged(Itunes.Respuesta respuesta) {
                //respuesta.results.forEach(contenido -> Log.e("ABCD", contenido.fields.titulo.stringValue + ", " + contenido.trackName + ", " + contenido.artworkUrl100));
            }
        });
    ...
    class ContenidosAdapter extends RecyclerView.Adapter<ContenidoViewHolder>{
        ...
        public void onBindViewHolder(@NonNull ContenidoViewHolder holder, int position) {
            ...
            holder.binding.title.setText(contenido.fields.nombre.stringValue);
            holder.binding.artist.setText(contenido.fields.descripcion.stringValue);
            holder.binding.edad.setText(""+contenido.fields.edadMax.integerValue);
            Glide.with(requireActivity()).load(contenido.fields.aspecto.stringValue).into(holder.binding.artwork);
        }
